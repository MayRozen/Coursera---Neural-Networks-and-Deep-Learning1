...
def layer_sizes(X, Y):
    ...
    # n_y = ... 
    # YOUR CODE STARTS HERE
    n_x = X.shape[0]  # Input layer size, typically matches the number of features (2 in this case)
    n_h = 4           # Hidden layer size, as specified
    n_y = Y.shape[0]  # Output layer size, typically matches the number of classes (1 in this case)
    # YOUR CODE ENDS HERE
    return (n_x, n_h, n_y)
